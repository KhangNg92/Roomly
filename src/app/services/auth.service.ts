...
export class AuthService {
  ...
  private readonly rootURL = "https://roomly.herokuapp.com/api/users";
  ...
  getUsers() {
    return this.httpClient.get('https://roomly.herokuapp.com/api/users/list').subscribe((appts: any) => {
  ...
  checkMangerRole(managerString: string) {
     ...
     */
    return this.httpClient.post<any>('https://roomly.herokuapp.com/api/users/checkManager', {
      managerString
    });
  }
